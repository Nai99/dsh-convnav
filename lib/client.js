...
var CSS = ".cn-rail{position:fixed;width:24px;z-index:60;pointer-events:none;display:flex;flex-direction:column;align-items:flex-start;gap:6px;padding:4px 0;transform:translateY(-50%)}\n" +
